...
import com.rameysoft.easypos.backend.services.LoginService;
...
public class LoginView extends 	VerticalLayout {
        ...
        signin.addClickListener(new ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
            	if(event.getSource().equals(signin)){
        			User user = loginService.authenticate(username.getValue(),password.getValue());
        			appEventBus.post(new AppEvent.UserAuthenticatedEvent(user));
        		}
            }
        });
        return fields;
    ...
    private Component buildLabels() {
        ...
        Label title = new Label("Easy POS Dashboard");
